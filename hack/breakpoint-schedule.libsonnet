{
  ...
  authorization: {
    'K6/api/tests/authorization/get-authorized-parties/breakpoint.yaml': {
    ...
    'K6/api/tests/authorization/connections/breakpoint.yaml': {
    ...
    'K6/api/tests/authorization/roles/breakpoint.yaml': {
