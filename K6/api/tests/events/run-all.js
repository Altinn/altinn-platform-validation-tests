import runGetAppEvents, { setup as setupGetAppEvents } from "./get-app-events.js";
import runGetSubscriptions, { setup as setupGetSubscriptions } from "./get-subscriptions.js";
...
export function setup() {
    return {
        getAppEvents: setupGetAppEvents(),
        getSubscriptions: setupGetSubscriptions(),
    };
}
...
export default function (data) {
    runGetAppEvents(data.getAppEvents);
    runGetSubscriptions();
}
