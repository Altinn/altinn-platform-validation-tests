...
export function setup() {
    ...
    const res = http.get(`https://raw.githubusercontent.com/Altinn/altinn-platform-validation-tests/refs/heads/fix-unique-testdata/K6/testdata/authentication/delegation/${__ENV.ENVIRONMENT}/instance-delegation-user-user.csv`);
