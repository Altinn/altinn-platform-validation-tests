...
export function setup() {
    ...
    const res = http.get(`https://raw.githubusercontent.com/Altinn/altinn-platform-validation-tests/refs/heads/pdp-single-rights-revisited/K6/testdata/authentication/single-rights-${__ENV.ENVIRONMENT}-v2.csv`);
