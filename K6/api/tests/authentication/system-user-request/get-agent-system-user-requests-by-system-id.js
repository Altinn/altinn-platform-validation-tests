...
export default function () {
    ...
    group("As a vendor, I can list agent system user requests by system id and follow pagination", function () {
        ...
        group("Fetch the first page of agent system user requests", function () {
            ...
            SystemUserRequestDomainChecks.CheckPaginatedShape(firstPage, "VendorAgentGetBySystem");
            SystemUserRequestDomainChecks.CheckPaginatedNotEmpty(firstPage, "VendorAgentGetBySystem");
        ...
        group("Follow the next-link pagination", function () {
            ...
            SystemUserRequestDomainChecks.CheckMultiplePages(1 + additionalPages, "VendorAgentGetBySystem");
        });
    });
}
