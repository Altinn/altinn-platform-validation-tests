...
export default function (testData) {
  ...
  group(groupLabel, function () {
    ...
    PostDelegations(bffAccessPackageApiClient, { party: from.partyUuid, to: to.partyUuid, from: from.partyUuid, packageId: accessPackage.id }, accessPackageLabel);
    DeleteDelegations(bffAccessPackageApiClient, { party: from.partyUuid, to: to.partyUuid, from: from.partyUuid, packageId: accessPackage.id }, accessPackageDeleteLabel);
  });
}
