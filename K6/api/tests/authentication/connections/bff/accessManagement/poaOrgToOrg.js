...
import { BffConnectionsApiClient, BffAccessPackageApiClient, ClientDelegationsApiClient } from "../../../../../../clients/authentication/index.js";
...
export default function (testData) {
  ...
  const bffAccessPackageApiClient = new BffAccessPackageApiClient(__ENV.BASE_URL, tokenGenerator);
  ...
  group(fullmaktGroup, function () {
    GetPermission(bffAccessPackageApiClient, accessPackage.id, { from: from.orgUuid, party: from.orgUuid }, getPermissionsLabel);
    ...
    PostDelegations(bffAccessPackageApiClient, { party: from.orgUuid, to: to.orgUuid, from: from.orgUuid, packageId: accessPackage.id }, postDelegationLabel);
  });
  ...
  group(cleanupGroup, function () {
    ...
    tokenGenerator.setTokenGeneratorOptions(getTokenOpts(from.userId, from.partyUuid));
    DeleteDelegations(bffAccessPackageApiClient, { party: from.orgUuid, to: to.orgUuid, from: from.orgUuid, packageId: accessPackage.id }, deleteAccessPackageLabel);
  });
