...
import { ConnectionsApiClient, ClientDelegationsApiClient, BffAccessPackageApiClient } from "../../../../../../clients/authentication/index.js";
...
function getClients(bff = false) {
  ...
  if (bffAccessPackageApiClient == undefined) {
    bffAccessPackageApiClient = new BffAccessPackageApiClient(__ENV.BASE_URL, tokenGenerator, bff);
  }
  return [connectionsApiClient, clientDelegationsApiClient, bffAccessPackageApiClient, tokenGenerator];
}
...
export default function (testData) {
  ...
  const bff = true;
  const [connectionsApiClient, clientDelegationsApiClient, bffAccessPackageApiClient, tokenGenerator] = getClients(bff);
