import runGetApplications, { setup as setupGetApplications } from "./get-applications.js";
import runQueryInstances, { setup as setupQueryInstances } from "./query-instances.js";
...
export function setup() {
    return {
        getApplications: setupGetApplications(),
        queryInstances: setupQueryInstances(),
    };
}
...
export default function (data) {
    runGetApplications(data.getApplications);
    runQueryInstances(data.queryInstances);
}
