...
export function setup() {
    ...
    return {
        resourceFilter: fetchTestData(`access-management/resource-owner/authorized-parties/resource-filter/${__ENV.ENVIRONMENT}.csv`, true, "test/subject-lookup-forms-from-csv"),
    };
}
