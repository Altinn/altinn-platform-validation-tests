 ...
 *
 * A sibling of resource-delegation-to-organization.js. One test per recipient type
...
export default function (data) {
    runResourceDelegation(data, "person");
}

/**
 * Removes any person delegation the run left behind.
 *
 * @param {ReturnType<typeof setup>} data Environment-specific test data.
 * @returns {void}
 */
export function teardown(data) {
    revokeDelegations(data, "person");
}
