...
// Daglig leder C skal se underenhet D i lista via underenhet C
// Prerequisite: Underenhet D delegerer tilgangspakker, enkeltrettigheter og instanstilgang til underenhet C
...
export default function (data) {
    if (skipDueToKnownBug) {
        console.warn("dagligleder-c-sees-underenhet-d is skipped due to a known bug");
        return;
    }
