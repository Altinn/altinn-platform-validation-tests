...
// Underenhet-C ---> Hovedenhet-B (U2H)
// Underenhet C delegerer tilgangspakke og altinn app til hovedenhet B, og daglig leder av
// hovedenhet B skal se underenhet C i aktørlista.
const groupLabel = "dagl-B-får-underenhet-C-i-aktørlista";
