 ...
 * @returns {{value: AccessListInfoDto|null, etag: string|null, status: number}} Deleted access list information as `value`
...
export function AccessListDelete(
    ...
    const res = expecting(expectedStatus, () => withRetries(
        () => accessListClient.AccessListDelete(owner, identifier, options?.headers ?? {}, labels),
        "AccessListDelete",
    ));
    ...
    const succeed = check(res, {
        [`AccessListDelete - status code is ${expectedStatus}`]: (r) =>
