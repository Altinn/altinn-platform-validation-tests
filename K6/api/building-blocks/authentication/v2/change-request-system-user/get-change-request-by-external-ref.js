 ...
 */
export function GetChangeRequestByExternalRef(
    ...
    const succeed = check(res, {
        "GetChangeRequestByExternalRef - status code is 200": (
            r,
        ) => r.status === 200,
        "GetChangeRequestByExternalRef - status text is 200 OK":
    ...
    check(res, {
        "GetChangeRequestByExternalRef - body is valid": (r) => {
            try {
