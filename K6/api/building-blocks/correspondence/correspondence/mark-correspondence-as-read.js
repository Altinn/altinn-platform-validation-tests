 ...
 */
export function MarkCorrespondenceAsRead(
    ...
    const succeed = check(res, {
        "MarkCorrespondenceAsRead - status code is 200": (r) =>
            r.status === 200,
        "MarkCorrespondenceAsRead - status text is 200 OK": (r) =>
    ...
    check(res, {
        "MarkCorrespondenceAsRead - body is valid": (r) => {
            try {
