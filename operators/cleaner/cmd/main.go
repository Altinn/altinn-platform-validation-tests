...
import (
	...
	"github.com/Altinn/altinn-platform-validation-tests/operators/cleaner/internal/controller"
...
func init() {
	...
	utilruntime.Must(k6iov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "fdf1a874.k6.dis.altinn.cloud",
	...
	if err := (&controller.ConfigMapReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "configmap")
		os.Exit(1)
	}
